...
dependency : gitSubModule
	...
	cp ./3rdparty/myBase64/out/libmyBase64.a ./src/lib/libmyBase64.a
	[ -d ./src/include/myBase64 ] || mkdir -p ./src/include/myBase64
	cp ./3rdparty/myBase64/src/myBase64.h ./src/include/myBase64/myBase64.h
